...
img_back = "5.png"  # фон гри
img_hero = "3.png"  # герой
img_bullet = "rocket.png" # куля
img_enemy = "2.png"  # ворог
...
while run:
    ...
    if not finish:
        ...
        for c in collides:
            score = score + 1
            monster = Enemy(img_enemy,randint(80,win_height -80), -40 , 80,50,randint(1,4))
            monsters.add(monster)
